...
write.csv(
  tune_res_data,
  '_data/Tables/rf_tuning_results_landsat.csv',
  row.names = FALSE
)

write.csv(
  regular_res_data,
  '_data/Tables/rf_tuning_results_refined_landsat.csv',
  row.names = FALSE
)

write.csv(
  final_res_data,
  '_data/Tables/rf_tuning_results_final_res_landsat.csv',
  row.names = FALSE
)

# Optional: save plots
ggsave(
  filename = '_data/Tables/rf_tuning_results_plot_landsat.png',
  plot = tune_res_plot,
  width = 7,
  height = 4,
  dpi = 300
...
ggsave(
  filename = '_data/Tables/rf_tuning_results_refined_plot_landsat.png',
